-- ========================================
-- SCRIPT DE SINCRONIZACIÓN (Generado: 8/7/2026 7:51:20 PM)
-- ========================================
...
-- Agregar columna: fza_albaranes.CODIGO_ALM_ALB
ALTER TABLE `fza_albaranes` ADD COLUMN `CODIGO_ALM_ALB` varchar(10) NULL DEFAULT NULL COMMENT 'Almacen de salida de la mercancia';
...
-- Agregar índice: fza_albaranes.IDX_ALB_ALMACEN
ALTER TABLE `fza_albaranes` ADD INDEX `IDX_ALB_ALMACEN` (`CODIGO_ALM_ALB`);
...
-- Agregar índice: fza_albaranes_celdas.IDX_ALBCEL_AV_PIVOT
...
-- Agregar columna: fza_albaranes_compra.ESIVA_EXENTO_INTRACOMUNITARIO_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `ESIVA_EXENTO_INTRACOMUNITARIO_ALBC` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S = IVA exento por proveedor intracomunitario';

-- Agregar columna: fza_albaranes_compra.TOTAL_BRUTO_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `TOTAL_BRUTO_ALBC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_albaranes_compra.PORCENTAJE_DTO_COMERCIAL_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `PORCENTAJE_DTO_COMERCIAL_ALBC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_albaranes_compra.TOTAL_DTO_COMERCIAL_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `TOTAL_DTO_COMERCIAL_ALBC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_albaranes_compra.PORCENTAJE_DTO_FINANCIERO_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `PORCENTAJE_DTO_FINANCIERO_ALBC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_albaranes_compra.TOTAL_DTO_FINANCIERO_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `TOTAL_DTO_FINANCIERO_ALBC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_albaranes_compra.ID_PV_TEMPORADA_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `ID_PV_TEMPORADA_ALBC` int(11) NULL DEFAULT NULL COMMENT 'FK logica fza_propiedades_valores.ID_PV_ARTPROP con ID_PROP_PV=TEMPORADA. Procede de ocalbpro.Temporada en la migracion.';

-- Modificar columna: fza_albaranes_compra.ESPIVOTE_HORIZONTAL_ALBC
UPDATE `fza_albaranes_compra` SET `ESPIVOTE_HORIZONTAL_ALBC` = LEFT(`ESPIVOTE_HORIZONTAL_ALBC`, 1) WHERE LENGTH(`ESPIVOTE_HORIZONTAL_ALBC`) > 1;
UPDATE `fza_albaranes_compra` SET `ESPIVOTE_HORIZONTAL_ALBC` = '' WHERE `ESPIVOTE_HORIZONTAL_ALBC` IS NULL;
ALTER TABLE `fza_albaranes_compra` MODIFY COLUMN `ESPIVOTE_HORIZONTAL_ALBC` varchar(1) NOT NULL DEFAULT 'N';

-- Agregar índice: fza_albaranes_compra.IDX_ALBC_TEMPORADA
ALTER TABLE `fza_albaranes_compra` ADD INDEX `IDX_ALBC_TEMPORADA` (`ID_PV_TEMPORADA_ALBC`);
...
-- Agregar columna: fza_caja_arqueos.TOTAL_VENTA_CREDITO_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `TOTAL_VENTA_CREDITO_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Ventas a crédito / albarán (legacy ImpAlbaranCdo)';

-- Agregar columna: fza_caja_arqueos.TOTAL_DEPOSITOS_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `TOTAL_DEPOSITOS_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Depósitos (legacy ImpDeposito)';

-- Agregar columna: fza_caja_arqueos.TOTAL_ENCARGOS_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `TOTAL_ENCARGOS_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Encargos (legacy ImpEncargo)';

-- Agregar columna: fza_caja_arqueos.TOTAL_RECUENTO_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `TOTAL_RECUENTO_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Suma de los importes recontados por el usuario';

-- Agregar columna: fza_caja_arqueos.DIFERENCIA_TOTAL_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `DIFERENCIA_TOTAL_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Recuento - Saldo teórico (positivo = sobrante)';

-- Agregar columna: fza_caja_arqueos.EFECTIVO_DEJADO_CAJA_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `EFECTIVO_DEJADO_CAJA_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Efectivo que se deja en caja como cambio para el día siguiente';

-- Agregar columna: fza_caja_arqueos.DESGLOSE_BILLETES_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `DESGLOSE_BILLETES_ARQ` text NULL DEFAULT NULL COMMENT 'Desglose billetes/monedas formato denom:uds;...';

-- Agregar columna: fza_caja_arqueos.IMPORTE_RETIRADA_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `IMPORTE_RETIRADA_ARQ` decimal(19,6) NOT NULL DEFAULT '0.000000';

-- Agregar columna: fza_caja_arqueos.CONCEPTO_RETIRADA_ARQ
ALTER TABLE `fza_caja_arqueos` ADD COLUMN `CONCEPTO_RETIRADA_ARQ` varchar(100) NULL DEFAULT NULL;

-- Agregar columna: fza_clientes.NOMBRE_PERSONA_CLIENTE_CLI
ALTER TABLE `fza_clientes` ADD COLUMN `NOMBRE_PERSONA_CLIENTE_CLI` varchar(80) NULL DEFAULT NULL;

-- Agregar columna: fza_clientes.APELLIDOS_PERSONA_CLIENTE_CLI
ALTER TABLE `fza_clientes` ADD COLUMN `APELLIDOS_PERSONA_CLIENTE_CLI` varchar(120) NULL DEFAULT NULL;

-- Agregar columna: fza_clientes.ID_MANDATO_SEPA_CLI
ALTER TABLE `fza_clientes` ADD COLUMN `ID_MANDATO_SEPA_CLI` varchar(35) NULL DEFAULT NULL COMMENT 'Identificador del mandato SEPA de adeudo';

-- Agregar columna: fza_clientes.FECHA_FIRMA_MANDATO_SEPA_CLI
ALTER TABLE `fza_clientes` ADD COLUMN `FECHA_FIRMA_MANDATO_SEPA_CLI` date NULL DEFAULT NULL COMMENT 'Fecha de firma del mandato SEPA de adeudo';

-- Agregar columna: fza_compras_sesiones.FECHA_TOPE_RECEPCION_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `FECHA_TOPE_RECEPCION_SES` date NULL DEFAULT NULL COMMENT 'Fecha limite prevista para recibir la mercancia';

-- Agregar columna: fza_compras_sesiones.FORMA_PAGO_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `FORMA_PAGO_SES` varchar(200) NULL DEFAULT NULL COMMENT 'Codigo de forma de pago (fza_formas_pago)';

-- Agregar columna: fza_compras_sesiones.CODIGO_IVA_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `CODIGO_IVA_SES` varchar(20) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.ESVARIOS_TIPOS_IVA_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `ESVARIOS_TIPOS_IVA_SES` varchar(1) NOT NULL DEFAULT 'N';

-- Agregar columna: fza_compras_sesiones.ESIVA_EXENTO_INTRACOMUNITARIO_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `ESIVA_EXENTO_INTRACOMUNITARIO_SES` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S = IVA exento por proveedor intracomunitario';

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_IVAN_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_IVAN_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_BASEI_IVAN_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_BASEI_IVAN_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_IVAN_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_IVAN_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_REN_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_REN_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_REN_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_REN_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_IVAR_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_IVAR_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_BASEI_IVAR_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_BASEI_IVAR_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_IVAR_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_IVAR_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_RER_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_RER_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_RER_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_RER_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_IVAS_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_IVAS_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_BASEI_IVAS_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_BASEI_IVAS_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_IVAS_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_IVAS_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_RES_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_RES_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_RES_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_RES_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_IVAE_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_IVAE_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_BASEI_IVAE_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_BASEI_IVAE_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_IVAE_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_IVAE_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_REE_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_REE_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_REE_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_REE_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_RETENCION_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_RETENCION_SES` decimal(19,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_RETENCION_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_RETENCION_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_BRUTO_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_BRUTO_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_DTO_COMERCIAL_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_DTO_COMERCIAL_SES` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_compras_sesiones.TOTAL_DTO_COMERCIAL_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_DTO_COMERCIAL_SES` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_compras_sesiones.PORCENTAJE_DTO_FINANCIERO_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `PORCENTAJE_DTO_FINANCIERO_SES` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_compras_sesiones.TOTAL_DTO_FINANCIERO_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_DTO_FINANCIERO_SES` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_compras_sesiones.TOTAL_BASES_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_BASES_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_IMPUESTOS_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_IMPUESTOS_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar columna: fza_compras_sesiones.TOTAL_LIQUIDO_SES
ALTER TABLE `fza_compras_sesiones` ADD COLUMN `TOTAL_LIQUIDO_SES` decimal(18,6) NULL DEFAULT NULL;

-- Agregar índice: fza_compras_sesiones.IDX_SES_FECHA_TOPE_RECEPCION
ALTER TABLE `fza_compras_sesiones` ADD INDEX `IDX_SES_FECHA_TOPE_RECEPCION` (`FECHA_TOPE_RECEPCION_SES`);
...
-- Agregar columna: fza_devoluciones_compra.ESIVA_EXENTO_INTRACOMUNITARIO_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `ESIVA_EXENTO_INTRACOMUNITARIO_DEVC` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S = IVA exento por proveedor intracomunitario';

-- Agregar columna: fza_devoluciones_compra.TOTAL_BRUTO_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `TOTAL_BRUTO_DEVC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_devoluciones_compra.PORCENTAJE_DTO_COMERCIAL_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `PORCENTAJE_DTO_COMERCIAL_DEVC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_devoluciones_compra.TOTAL_DTO_COMERCIAL_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `TOTAL_DTO_COMERCIAL_DEVC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_devoluciones_compra.PORCENTAJE_DTO_FINANCIERO_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `PORCENTAJE_DTO_FINANCIERO_DEVC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_devoluciones_compra.TOTAL_DTO_FINANCIERO_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `TOTAL_DTO_FINANCIERO_DEVC` decimal(18,6) NULL DEFAULT '0.000000';

-- Modificar columna: fza_devoluciones_compra.ESPIVOTE_HORIZONTAL_DEVC
UPDATE `fza_devoluciones_compra` SET `ESPIVOTE_HORIZONTAL_DEVC` = LEFT(`ESPIVOTE_HORIZONTAL_DEVC`, 1) WHERE LENGTH(`ESPIVOTE_HORIZONTAL_DEVC`) > 1;
UPDATE `fza_devoluciones_compra` SET `ESPIVOTE_HORIZONTAL_DEVC` = '' WHERE `ESPIVOTE_HORIZONTAL_DEVC` IS NULL;
ALTER TABLE `fza_devoluciones_compra` MODIFY COLUMN `ESPIVOTE_HORIZONTAL_DEVC` varchar(1) NOT NULL DEFAULT 'N';
...
-- Tabla nueva: fza_documentos_trabajo
CREATE TABLE `fza_documentos_trabajo` (
  ...
  `OBSERVACIONES_DTR` text NULL DEFAULT NULL,
...
-- Agregar índice: fza_documentos_trabajo.IDX_DTR_ESTADO
ALTER TABLE `fza_documentos_trabajo` ADD INDEX `IDX_DTR_ESTADO` (`ESTADO_DTR`);

-- Agregar índice: fza_documentos_trabajo.IDX_DTR_INSTANTE
ALTER TABLE `fza_documentos_trabajo` ADD INDEX `IDX_DTR_INSTANTE` (`INSTANTE_DOCUMENTO_DTR`);

-- Agregar índice: fza_documentos_trabajo.IDX_DTR_USUARIO
ALTER TABLE `fza_documentos_trabajo` ADD INDEX `IDX_DTR_USUARIO` (`USUARIO_DTR`);
...
-- Agregar índice: fza_documentos_trabajo_celdas.IDX_DTRCEL_AV_PIVOT
ALTER TABLE `fza_documentos_trabajo_celdas` ADD INDEX `IDX_DTRCEL_AV_PIVOT` (`ID_AV_PIVOT_DTRCEL`);

-- Tabla nueva: fza_documentos_trabajo_compartidos
CREATE TABLE `fza_documentos_trabajo_compartidos` (
...
-- Agregar índice: fza_documentos_trabajo_compartidos.IDX_DTC_DTR
ALTER TABLE `fza_documentos_trabajo_compartidos` ADD INDEX `IDX_DTC_DTR` (`ID_DTR_DTC`);

-- Agregar índice: fza_documentos_trabajo_compartidos.IDX_DTC_TIPO_DESTINO_USUARIO_GRUPO
ALTER TABLE `fza_documentos_trabajo_compartidos` ADD INDEX `IDX_DTC_TIPO_DESTINO_USUARIO_GRUPO` (`TIPO_DESTINO_DTC`, `USUARIO_GRUPO_DTC`);

-- Agregar índice: fza_documentos_trabajo_compartidos.IDX_DTC_USUARIO
ALTER TABLE `fza_documentos_trabajo_compartidos` ADD INDEX `IDX_DTC_USUARIO` (`USUARIO_DTC`);

-- Agregar índice: fza_documentos_trabajo_compartidos.UQ_DTC_DTR_TIPO_DESTINO_USUARIO_GRUPO
ALTER TABLE `fza_documentos_trabajo_compartidos` ADD UNIQUE INDEX `UQ_DTC_DTR_TIPO_DESTINO_USUARIO_GRUPO` (`ID_DTR_DTC`, `TIPO_DESTINO_DTC`, `USUARIO_GRUPO_DTC`);

-- Tabla nueva: fza_documentos_trabajo_lineas
CREATE TABLE `fza_documentos_trabajo_lineas` (
  ...
  `CODIGO_ALM_DTL` varchar(10) NULL DEFAULT NULL,
  `LOTE_DTL` varchar(50) NOT NULL DEFAULT '',
  `FECHA_CADUCIDAD_DTL` date NULL DEFAULT NULL,
  `DESCRIPCION_ARTICULO_DTL` varchar(200) NULL DEFAULT NULL,
  `DESCRIPCION_UNIDAD_DTL` varchar(200) NULL DEFAULT NULL,
  ...
  `ORIGEN_DTL` varchar(30) NULL DEFAULT NULL,
  `OBSERVACIONES_DTL` varchar(500) NULL DEFAULT NULL,
  `INSTANTE_MODIF` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE CURRENT_TIMESTAMP,
  `INSTANTE_ALTA` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `USUARIO_ALTA` varchar(100) NOT NULL DEFAULT 'SISTEMA',
  `USUARIO_MODIF` varchar(100) NOT NULL DEFAULT 'SISTEMA',
...
-- Agregar índice: fza_documentos_trabajo_lineas.IDX_DTL_ALM
ALTER TABLE `fza_documentos_trabajo_lineas` ADD INDEX `IDX_DTL_ALM` (`CODIGO_ALM_DTL`);

-- Agregar índice: fza_documentos_trabajo_lineas.IDX_DTL_ART
ALTER TABLE `fza_documentos_trabajo_lineas` ADD INDEX `IDX_DTL_ART` (`CODIGO_ART_DTL`);

-- Agregar índice: fza_documentos_trabajo_lineas.IDX_DTL_DTR
ALTER TABLE `fza_documentos_trabajo_lineas` ADD INDEX `IDX_DTL_DTR` (`ID_DTR_DTL`);

-- Agregar índice: fza_documentos_trabajo_lineas.IDX_DTL_UNIDAD
ALTER TABLE `fza_documentos_trabajo_lineas` ADD INDEX `IDX_DTL_UNIDAD` (`CODIGO_UNIDAD_DTL`);

-- Agregar índice: fza_documentos_trabajo_lineas.UQ_DTL_DTR_LINEA
ALTER TABLE `fza_documentos_trabajo_lineas` ADD UNIQUE INDEX `UQ_DTL_DTR_LINEA` (`ID_DTR_DTL`, `LINEA_DTL`);

-- Agregar columna: fza_empresas.NUMERO_INSTALACION_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `NUMERO_INSTALACION_EMP` varchar(60) NULL DEFAULT NULL COMMENT 'NumeroInstalacion SIF devuelto por el servicio del productor';

-- Agregar columna: fza_empresas.VERSION_INSTALACION_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `VERSION_INSTALACION_EMP` varchar(60) NULL DEFAULT NULL COMMENT 'Version de Factuzam usada al obtener NumeroInstalacion';

-- Agregar columna: fza_empresas.CODIGO_SIF_INSTALACION_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `CODIGO_SIF_INSTALACION_EMP` varchar(2) NULL DEFAULT NULL COMMENT 'IdSistemaInformatico usado al obtener NumeroInstalacion';

-- Agregar columna: fza_empresas.INSTANTE_INSTALACION_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `INSTANTE_INSTALACION_EMP` datetime NULL DEFAULT NULL COMMENT 'Instante de obtencion de NumeroInstalacion';

-- Agregar columna: fza_empresas.TEXTO_PIE_TICKET_CAJA_1_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `TEXTO_PIE_TICKET_CAJA_1_EMP` varchar(42) NULL DEFAULT NULL COMMENT 'Linea 1 del pie del ticket de caja';

-- Agregar columna: fza_empresas.TEXTO_PIE_TICKET_CAJA_2_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `TEXTO_PIE_TICKET_CAJA_2_EMP` varchar(42) NULL DEFAULT NULL COMMENT 'Linea 2 del pie del ticket de caja';

-- Agregar columna: fza_empresas.TEXTO_PIE_TICKET_CAJA_3_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `TEXTO_PIE_TICKET_CAJA_3_EMP` varchar(42) NULL DEFAULT NULL COMMENT 'Linea 3 del pie del ticket de caja';

-- Agregar columna: fza_empresas.TEXTO_PIE_TICKET_CAJA_4_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `TEXTO_PIE_TICKET_CAJA_4_EMP` varchar(42) NULL DEFAULT NULL COMMENT 'Linea 4 del pie del ticket de caja';

-- Agregar columna: fza_empresas.ESTOKENS_CALENDARIO_NATURAL_EMP
ALTER TABLE `fza_empresas` ADD COLUMN `ESTOKENS_CALENDARIO_NATURAL_EMP` varchar(1) NOT NULL DEFAULT 'N';

-- Agregar columna: fza_empresas_bancos.CODIGO_ACREEDOR_SEPA_EMPBAN
ALTER TABLE `fza_empresas_bancos` ADD COLUMN `CODIGO_ACREEDOR_SEPA_EMPBAN` varchar(35) NULL DEFAULT NULL COMMENT 'Identificador de acreedor SEPA para adeudos';

-- Agregar columna: fza_empresas_series.SERIE_TOKENIZADA_EMPSER
ALTER TABLE `fza_empresas_series` ADD COLUMN `SERIE_TOKENIZADA_EMPSER` varchar(12) NULL DEFAULT NULL;

-- Tabla nueva: fza_errores_envios
CREATE TABLE `fza_errores_envios` (
  `ID_ERENV` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `CODIGO_HTTP_ERENV` int(11) NOT NULL DEFAULT '0',
  ...
  `ID_SCRIPT_REMOTO_ERENV` bigint(20) unsigned NULL DEFAULT NULL,
  ...
  `ID_EJECUTABLE_REMOTO_ERENV` bigint(20) unsigned NULL DEFAULT NULL,
  ...
  `CANTIDAD_BYTES_EJECUTABLE_ERENV` bigint(20) unsigned NULL DEFAULT NULL,
...
-- Agregar índice: fza_errores_envios.IDX_ERENV_ESTADO_INSTANTE
ALTER TABLE `fza_errores_envios` ADD INDEX `IDX_ERENV_ESTADO_INSTANTE` (`ESTADO_ERENV`, `INSTANTE_ERROR_ERENV`);

-- Agregar índice: fza_errores_envios.IDX_ERENV_REFERENCIA
ALTER TABLE `fza_errores_envios` ADD INDEX `IDX_ERENV_REFERENCIA` (`REFERENCIA_ERENV`);
...
-- Agregar índice: fza_facturacion_caja_periodos.IDX_FACPER_ESTADO
ALTER TABLE `fza_facturacion_caja_periodos` ADD INDEX `IDX_FACPER_ESTADO` (`ESTADO_FACPER`);

-- Agregar índice: fza_facturacion_caja_periodos.IDX_FACPER_REVISION
...
-- Agregar columna: fza_facturas.TIPO_RECTIFICATIVA_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `TIPO_RECTIFICATIVA_FAC` varchar(1) NULL DEFAULT NULL COMMENT 'I=por diferencias; S=sustitutiva';

-- Agregar columna: fza_facturas.TIPO_FACTURA_VERIFACTU_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `TIPO_FACTURA_VERIFACTU_FAC` varchar(2) NULL DEFAULT NULL COMMENT 'F1, F2, F3, R1, R2, R3, R4 o R5';

-- Agregar columna: fza_facturas.NOMBRE_PERSONA_CLIENTE_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `NOMBRE_PERSONA_CLIENTE_FAC` varchar(80) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas.APELLIDOS_PERSONA_CLIENTE_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `APELLIDOS_PERSONA_CLIENTE_FAC` varchar(120) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas.CODIGO_BARRAS_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `CODIGO_BARRAS_FAC` varchar(13) NULL DEFAULT NULL COMMENT 'EAN-13 del ticket (prefijo 29) para devoluciones';
...
-- Agregar índice: fza_facturas.UQ_FAC_CODIGO_BARRAS
ALTER TABLE `fza_facturas` ADD UNIQUE INDEX `UQ_FAC_CODIGO_BARRAS` (`CODIGO_BARRAS_FAC`);

-- Agregar columna: fza_facturas_compra.ESIVA_EXENTO_INTRACOMUNITARIO_FACC
ALTER TABLE `fza_facturas_compra` ADD COLUMN `ESIVA_EXENTO_INTRACOMUNITARIO_FACC` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S = IVA exento por proveedor intracomunitario';

-- Agregar columna: fza_facturas_compra.PORCENTAJE_DTO_FINANCIERO_FACC
ALTER TABLE `fza_facturas_compra` ADD COLUMN `PORCENTAJE_DTO_FINANCIERO_FACC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_facturas_compra.TOTAL_DTO_FINANCIERO_FACC
ALTER TABLE `fza_facturas_compra` ADD COLUMN `TOTAL_DTO_FINANCIERO_FACC` decimal(18,6) NULL DEFAULT '0.000000';

-- Modificar columna: fza_facturas_compra.ESPIVOTE_HORIZONTAL_FACC
UPDATE `fza_facturas_compra` SET `ESPIVOTE_HORIZONTAL_FACC` = LEFT(`ESPIVOTE_HORIZONTAL_FACC`, 1) WHERE LENGTH(`ESPIVOTE_HORIZONTAL_FACC`) > 1;
UPDATE `fza_facturas_compra` SET `ESPIVOTE_HORIZONTAL_FACC` = '' WHERE `ESPIVOTE_HORIZONTAL_FACC` IS NULL;
ALTER TABLE `fza_facturas_compra` MODIFY COLUMN `ESPIVOTE_HORIZONTAL_FACC` varchar(1) NOT NULL DEFAULT 'N';
...
-- Agregar columna: fza_facturas_consolidaciones.CODIGO_ERROR_AEAT_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `CODIGO_ERROR_AEAT_FACCON` varchar(20) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.DESCRIPCION_ERROR_AEAT_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `DESCRIPCION_ERROR_AEAT_FACCON` text NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.ESTADO_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `ESTADO_ORIGINAL_FACCON` varchar(30) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.CODIGO_ERROR_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `CODIGO_ERROR_ORIGINAL_FACCON` varchar(20) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.DESCRIPCION_ERROR_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `DESCRIPCION_ERROR_ORIGINAL_FACCON` text NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.RESPUESTA_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `RESPUESTA_ORIGINAL_FACCON` longtext NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.PETICION_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `PETICION_ORIGINAL_FACCON` longtext NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.REGISTRO_XML_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `REGISTRO_XML_ORIGINAL_FACCON` longtext NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.FIRMA_DIGITAL_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `FIRMA_DIGITAL_ORIGINAL_FACCON` longtext NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.MOTIVO_SUBSANACION_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `MOTIVO_SUBSANACION_FACCON` varchar(500) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.INSTANTE_SUBSANACION_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `INSTANTE_SUBSANACION_FACCON` datetime NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.USUARIO_SUBSANACION_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `USUARIO_SUBSANACION_FACCON` varchar(50) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.REQUEST_ID_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `REQUEST_ID_ORIGINAL_FACCON` varchar(255) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.CHAIN_NUMBER_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `CHAIN_NUMBER_ORIGINAL_FACCON` varchar(100) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.CHAIN_HASH_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `CHAIN_HASH_ORIGINAL_FACCON` varchar(255) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.SERIE_CERTIFICADO_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `SERIE_CERTIFICADO_ORIGINAL_FACCON` varchar(128) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.TITULAR_CERTIFICADO_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `TITULAR_CERTIFICADO_ORIGINAL_FACCON` varchar(1000) NULL DEFAULT NULL;

-- Agregar columna: fza_facturas_consolidaciones.HUELLA_CERTIFICADO_ORIGINAL_FACCON
ALTER TABLE `fza_facturas_consolidaciones` ADD COLUMN `HUELLA_CERTIFICADO_ORIGINAL_FACCON` char(40) NULL DEFAULT NULL;
...
-- Agregar índice: fza_facturas_lineas.IDX_FACLIN_NUMMOV
ALTER TABLE `fza_facturas_lineas` ADD INDEX `IDX_FACLIN_NUMMOV` (`NUMERO_MOV_FACLIN`);
...
-- Agregar índice: fza_filtros_guardados.IDX_FILT_MTO_VISTA
ALTER TABLE `fza_filtros_guardados` ADD INDEX `IDX_FILT_MTO_VISTA` (`MTO_FILT`, `VISTA_FILT`);

-- Agregar índice: fza_filtros_guardados.IDX_FILT_PROPIETARIO
ALTER TABLE `fza_filtros_guardados` ADD INDEX `IDX_FILT_PROPIETARIO` (`USUARIO_PROPIETARIO_FILT`);

-- Agregar índice: fza_filtros_guardados.UQ_FILT_MTO_VISTA_NOMBRE_PROP
...
-- Tabla nueva: fza_filtros_guardados_compartidos
...
-- Agregar índice: fza_filtros_guardados_compartidos.IDX_FILTC_FILT
ALTER TABLE `fza_filtros_guardados_compartidos` ADD INDEX `IDX_FILTC_FILT` (`ID_FILT_FILTC`);

-- Agregar índice: fza_filtros_guardados_compartidos.IDX_FILTC_TIPO_DESTINO_USUARIO_GRUPO
...
-- Agregar índice: fza_filtros_guardados_compartidos.UQ_FILTC_FILT_TIPO_DESTINO
...
-- Modificar columna: fza_generadorprocesos.PROCESO_GENERADOR_PROCESO_GP
UPDATE `fza_generadorprocesos` SET `PROCESO_GENERADOR_PROCESO_GP` = LEFT(`PROCESO_GENERADOR_PROCESO_GP`, 16777215) WHERE LENGTH(`PROCESO_GENERADOR_PROCESO_GP`) > 16777215;
ALTER TABLE `fza_generadorprocesos` MODIFY COLUMN `PROCESO_GENERADOR_PROCESO_GP` mediumtext NULL DEFAULT NULL;

-- Modificar índice: fza_informes_guias.PRIMARY
SET @pk_exists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'fza_informes_guias' AND constraint_type = 'PRIMARY KEY');
SET @sql_drop := IF(@pk_exists > 0, 'ALTER TABLE `fza_informes_guias` DROP PRIMARY KEY', 'SELECT "No Primary Key to drop"');
PREPARE stmt FROM @sql_drop;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

-- Descomenta para limpieza de duplicados previa a la creación de PK
-- DELETE FROM `fza_informes_guias` WHERE -- (`INFORME_INFGUI`, `FORMATO_INFGUI`, `CODIGO_INFGUI`) IN (-- SELECT `INFORME_INFGUI`, `FORMATO_INFGUI`, `CODIGO_INFGUI` FROM (-- SELECT `INFORME_INFGUI`, `FORMATO_INFGUI`, `CODIGO_INFGUI`-- FROM `fza_informes_guias`-- GROUP BY `INFORME_INFGUI`, `FORMATO_INFGUI`, `CODIGO_INFGUI`-- HAVING COUNT(*) > 1-- ) AS c-- );

-- Comprobación dinámica para evitar error si el ADD COLUMN ya creó la PK
SET @pk_exists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'fza_informes_guias' AND constraint_type = 'PRIMARY KEY');
SET @sql_add := IF(@pk_exists = 0, 'ALTER TABLE `fza_informes_guias` ADD PRIMARY KEY (`INFORME_INFGUI`, `FORMATO_INFGUI`, `CODIGO_INFGUI`)', 'SELECT "Primary Key ya existe"');
...
-- Agregar índice: fza_inventarios_celdas.IDX_INVCEL_AV_PIVOT
...
UPDATE `fza_movimientos_almacen` SET `LINEA_MOV` = LEFT(`LINEA_MOV`, 10) WHERE LENGTH(`LINEA_MOV`) > 10;
UPDATE `fza_movimientos_almacen` SET `LINEA_MOV` = '' WHERE `LINEA_MOV` IS NULL;
...
-- Agregar columna: fza_pedidos.CODIGO_ALM_PED
ALTER TABLE `fza_pedidos` ADD COLUMN `CODIGO_ALM_PED` varchar(10) NULL DEFAULT NULL COMMENT 'Almacen de salida por defecto del pedido';

-- Agregar índice: fza_pedidos.IDX_PED_ALMACEN
ALTER TABLE `fza_pedidos` ADD INDEX `IDX_PED_ALMACEN` (`CODIGO_ALM_PED`);
...
-- Agregar índice: fza_pedidos_celdas.IDX_PEDCEL_AV_PIVOT
ALTER TABLE `fza_pedidos_celdas` ADD INDEX `IDX_PEDCEL_AV_PIVOT` (`ID_AV_PIVOT_PEDCEL`);

-- Agregar columna: fza_pedidos_compra.FECHA_TOPE_RECEPCION_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `FECHA_TOPE_RECEPCION_PEDC` date NULL DEFAULT NULL COMMENT 'Fecha limite prevista para recibir la mercancia';

-- Agregar columna: fza_pedidos_compra.ESIVA_EXENTO_INTRACOMUNITARIO_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `ESIVA_EXENTO_INTRACOMUNITARIO_PEDC` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S = IVA exento por proveedor intracomunitario';

-- Agregar columna: fza_pedidos_compra.TOTAL_BRUTO_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `TOTAL_BRUTO_PEDC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_pedidos_compra.PORCENTAJE_DTO_COMERCIAL_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `PORCENTAJE_DTO_COMERCIAL_PEDC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_pedidos_compra.TOTAL_DTO_COMERCIAL_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `TOTAL_DTO_COMERCIAL_PEDC` decimal(18,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_pedidos_compra.PORCENTAJE_DTO_FINANCIERO_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `PORCENTAJE_DTO_FINANCIERO_PEDC` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_pedidos_compra.TOTAL_DTO_FINANCIERO_PEDC
ALTER TABLE `fza_pedidos_compra` ADD COLUMN `TOTAL_DTO_FINANCIERO_PEDC` decimal(18,6) NULL DEFAULT '0.000000';

-- Modificar columna: fza_pedidos_compra.ESPIVOTE_HORIZONTAL_PEDC
UPDATE `fza_pedidos_compra` SET `ESPIVOTE_HORIZONTAL_PEDC` = LEFT(`ESPIVOTE_HORIZONTAL_PEDC`, 1) WHERE LENGTH(`ESPIVOTE_HORIZONTAL_PEDC`) > 1;
ALTER TABLE `fza_pedidos_compra` MODIFY COLUMN `ESPIVOTE_HORIZONTAL_PEDC` varchar(1) NULL DEFAULT 'N' COMMENT 'S/N — recordar vista pivote de tallas al reabrir';

-- Agregar índice: fza_pedidos_compra.IDX_PEDC_FECHA_TOPE_RECEPCION
ALTER TABLE `fza_pedidos_compra` ADD INDEX `IDX_PEDC_FECHA_TOPE_RECEPCION` (`FECHA_TOPE_RECEPCION_PEDC`);
...
-- Modificar columna: fza_pedidos_lineas.LINEA_PEDLIN
UPDATE `fza_pedidos_lineas` SET `LINEA_PEDLIN` = LEFT(`LINEA_PEDLIN`, 4) WHERE LENGTH(`LINEA_PEDLIN`) > 4;
UPDATE `fza_pedidos_lineas` SET `LINEA_PEDLIN` = '' WHERE `LINEA_PEDLIN` IS NULL;
ALTER TABLE `fza_pedidos_lineas` MODIFY COLUMN `LINEA_PEDLIN` varchar(4) NOT NULL;
...
-- Agregar índice: fza_proformas_caja_lineas.IDX_PROCLIN_OPERACION
ALTER TABLE `fza_proformas_caja_lineas` ADD INDEX `IDX_PROCLIN_OPERACION` (`ID_OPCAJA_PROCLIN`);

-- Agregar índice: fza_proformas_caja_lineas.IDX_PROCLIN_PROFORMA_ORIGEN
...
-- Agregar índice: fza_proformas_caja_lineas.UQ_PROCLIN_ORIGEN
...
-- Agregar columna: fza_proveedores.CODIGO_PAI_PRV
ALTER TABLE `fza_proveedores` ADD COLUMN `CODIGO_PAI_PRV` varchar(3) NULL DEFAULT NULL COMMENT 'FK logica fza_paises.COD_ALPHA2_PAI (combo pais, ver vi_paises)';

-- Agregar columna: fza_proveedores.ESVARIOS_TIPOS_IVA_PRV
ALTER TABLE `fza_proveedores` ADD COLUMN `ESVARIOS_TIPOS_IVA_PRV` varchar(1) NOT NULL DEFAULT 'N';

-- Agregar columna: fza_proveedores.ESIVA_EXENTO_INTRACOMUNITARIO_PRV
ALTER TABLE `fza_proveedores` ADD COLUMN `ESIVA_EXENTO_INTRACOMUNITARIO_PRV` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S = IVA exento por proveedor intracomunitario';
...
-- Agregar columna: fza_remesas_venta.TIPO_SECUENCIA_SEPA_REMV
ALTER TABLE `fza_remesas_venta` ADD COLUMN `TIPO_SECUENCIA_SEPA_REMV` varchar(4) NULL DEFAULT 'RCUR' COMMENT 'Secuencia SEPA del adeudo: FRST, RCUR, OOFF o FNAL';

-- Tabla nueva: fza_tarifas_cambios
CREATE TABLE `fza_tarifas_cambios` (
  ...
  `VALOR_APLICACION_TARC` decimal(19,6) NOT NULL DEFAULT '0.000000',
  `VALOR_REDONDEO_TARC` decimal(19,6) NOT NULL DEFAULT '0.010000',
  `VALOR_MENOS_AJUSTE_TARC` decimal(19,6) NOT NULL DEFAULT '0.000000',
  ...
  `FECHA_DESDE_DTO_TARC` date NULL DEFAULT NULL,
  `FECHA_HASTA_DTO_TARC` date NULL DEFAULT NULL,
...
-- Tabla nueva: fza_tarifas_cambios_lineas
CREATE TABLE `fza_tarifas_cambios_lineas` (
...
-- Agregar índice: fza_tarifas_cambios_lineas.IDX_TARCLIN_TAR_DEST
ALTER TABLE `fza_tarifas_cambios_lineas` ADD INDEX `IDX_TARCLIN_TAR_DEST` (`CODIGO_TAR_DESTINO_TARCLIN`);

-- Agregar índice: fza_tarifas_cambios_lineas.UQ_TARCLIN_TARC_ART_SKU
ALTER TABLE `fza_tarifas_cambios_lineas` ADD UNIQUE INDEX `UQ_TARCLIN_TARC_ART_SKU` (`CODIGO_TARC_TARCLIN`, `CODIGO_ART_TARCLIN`, `CODIGO_UNIDAD_SKU_TARCLIN`);

-- Tabla nueva: fza_traducciones
CREATE TABLE `fza_traducciones` (
  ...
  `ESDESCARGADA_TRAD` varchar(1) NOT NULL DEFAULT 'N',
  `INSTANTE_ALTA` datetime NOT NULL DEFAULT current_timestamp(),
...
-- Agregar índice: fza_traducciones.IDX_TRAD_IDIOMA_ACTIVO
ALTER TABLE `fza_traducciones` ADD INDEX `IDX_TRAD_IDIOMA_ACTIVO` (`IDIOMA_TRAD`, `ESACTIVO_TRAD`);

-- Agregar índice: fza_traducciones.UQ_TRAD_CLAVE_IDIOMA
ALTER TABLE `fza_traducciones` ADD UNIQUE INDEX `UQ_TRAD_CLAVE_IDIOMA` (`CLAVE_TRAD`, `IDIOMA_TRAD`);

-- Agregar columna: fza_traspasos_solicitudes_lineas.MOTIVO_RECHAZO_TRSOLLIN
ALTER TABLE `fza_traspasos_solicitudes_lineas` ADD COLUMN `MOTIVO_RECHAZO_TRSOLLIN` varchar(255) NULL DEFAULT NULL COMMENT 'Motivo si la linea se deniega (servida=0)';
...
-- Agregar índice: fza_ventas_ws_cola.IDX_VWSC_DOCUMENTO
ALTER TABLE `fza_ventas_ws_cola` ADD INDEX `IDX_VWSC_DOCUMENTO` (`CODIGO_EMP_VWSC`, `SERIE_FAC_VWSC`, `NUMERO_FAC_VWSC`);

-- Agregar índice: fza_ventas_ws_cola.IDX_VWSC_ESTADO_PROXIMO
ALTER TABLE `fza_ventas_ws_cola` ADD INDEX `IDX_VWSC_ESTADO_PROXIMO` (`ESTADO_VWSC`, `INSTANTE_PROXIMO_INTENTO_VWSC`);

-- Agregar índice: fza_ventas_ws_cola.UQ_VWSC_EVENTO
ALTER TABLE `fza_ventas_ws_cola` ADD UNIQUE INDEX `UQ_VWSC_EVENTO` (`ID_EVENTO_VWSC`);

-- Agregar columna: fza_verifactu_cola.MOTIVO_VFCOLA
ALTER TABLE `fza_verifactu_cola` ADD COLUMN `MOTIVO_VFCOLA` varchar(500) NULL DEFAULT NULL;
